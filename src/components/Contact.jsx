    ...
    <section id="contact" className="section" style={{ background: 'var(--bg-secondary)', position: 'relative' }}>
      <div className="container">
        ...
        <div style={{ maxWidth: '750px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }} className="contact-direct-grid">
            {/* Direct Email Card */}
            <a
            ...
            >
              ...
              <div style={{ overflow: 'hidden' }}>
                ...
                <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>+94 77 974 3901</p>
              </div>
            </a>
          </div>
