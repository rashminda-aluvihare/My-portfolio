  ...
  const projectsList = [
    {
      ...
      tags: ['React.js', 'Node.js', 'PostgreSQL', 'SHA-256 Ledger', 'Railway', 'Vercel'],
    ...
    },
    {
      ...
      tags: ['Scope Coordination', 'SRS Documentation', 'PHP', 'MySQL', 'Role Dashboards'],
    ...
    },
    {
      ...
      description: 'Engineered a custom full-stack ERP and trilingual web portal for an active physical carpentry workshop in Sri Lanka',
      tags: ['Client Project', 'Spring Boot', 'React.js', 'MySQL', 'Trilingual (EN|SI|TA)', 'Quotation Engine', 'Billing Ledger'],
